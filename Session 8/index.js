//Ex1:
// let count = 0;
// count = document.getElementById("value").textContent;
...
//     quoteText.textContent = (quotes[randomQuotes].quoteText);
//     quoteAuthor.textContent = (quotes[randomQuotes].quoteAuthor);
