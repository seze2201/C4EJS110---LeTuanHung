...
//     }
//Q2:
    // const task = {subject:'implement login feature',createdBy:'Hoang Ngoc Duc',assignTo:'Nguyen Phuong Nam',dueDate:'2019-10-08T18:00:00+0000',expectedHours:0.5}
...
//     UIandUX: 'UI means User Interface,UX means User Experience, are the process to define how your looks good and feels',
// }
//Q4.1 4.2:
// var words = prompt('Hi there, this is dev dictionary');
// if(dictionary[words]){
//     alert(`${words}\n${dictionary[words]}`)
// }
// else {
//     let d = prompt('We could not find your words: ' + words +' Leave your explanation');
//     dictionary[words] = d;
//     alert("done");
//     words = prompt('Enter a keyword');
//     alert(dictionary[words])    ;
// }
//Q5 : 
// var products = [
//     {
...
// let i = 1;
// for(let x of products){
//     console.log(`#${Number(i)}.${x.name}\n   Price:${x.price}`);
//     i++;
// }
// let posOfProduct = Number(prompt('Enter product position'));
// console.log(products[posOfProduct-1]);

//5.3
// let enterCategory = prompt('Enter your category').toLowerCase();
// for(let x of products){
//     if(x.category.toLowerCase() == enterCategory){
//         console.log(`Name:${x.name}`);
//         console.log(`Price:${x.price}`);
//         console.log('---------------------------------------');
//     }
...
//     let command = prompt('Enter a command (New, Update, Delete, Complete)').toLowerCase();
//     if(command == 'new'){
//         let newTask = prompt('Enter a new task');
//         frontEndDeveloper.push({task:newTask, complete:'False'});
//     }
//     else if(command == 'update'){
//         let pos = Number(prompt('Enter position'));
//         let newTittle = prompt('Enter new tittle');
//         frontEndDeveloper[pos-1].task = newTittle;
//     }  
//     else if(command == 'complete'){
//         let pos2 = Number(prompt('Enter a position'));
//         frontEndDeveloper[pos2-1].complete = 'true';
//     } 
